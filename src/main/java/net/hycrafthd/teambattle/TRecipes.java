...
public class TRecipes {
	...
	private void crafing() {
		...
		CommonRegistryUtil.registerShapedCraftingRecipe(new ItemStack(TBlocks.teambattleanvil), new Object[] { "ibi", "bab", "ibi", 'i', TItems.teambattleingot, 'b', Blocks.iron_block, 'a', Blocks.anvil });
